...
define(function () {
    ...
    angularAMD.prototype.route = function (config) {
        ...
        */
        ...
        //添加controller的function实现,用于处理动态路由
        else if (typeof config.controller === 'function') {
            load_controller = config.controller();
            config.controller = load_controller;
        }
    ...
    angularAMD.prototype.bootstrap = function (app, enable_ngload, elem) {
        ...
        function (controllerProvider, compileProvider, filterProvider, animateProvider, provide,routeParams) {
                // Cache Providers
                app_cached_providers = {
