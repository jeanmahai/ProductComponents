...
<div class="pure-u-1-1 top">
    ...
    <div class="n-top-menu">
        <ul>
            <li><a href="#"><img src="images/logout.png"
...
<div class="pure-u-4-24 left">
    ...
    <div class="pure-menu pure-menu-open n-menu ">
        <a class="pure-menu-heading"><img src="images/customers.png"/>客户管理</a>
    ...
    <div class="pure-menu pure-menu-open n-menu ">
        <a class="pure-menu-heading"><img src="images/care.png"/>用户关怀</a>
        <ul style="display: none;">
    ...
    <div class="pure-menu pure-menu-open n-menu ">
        <a class="pure-menu-heading"><img src="images/info.png"/>信息管理</a>
        <ul style="display: none;">
    ...
    <div class="pure-menu pure-menu-open n-menu ">
        <a class="pure-menu-heading"><img src="images/report.png"/>数据分析</a>
        <ul style="display: none;">
    ...
    <div class="pure-menu pure-menu-open n-menu ">
        <a class="pure-menu-heading"><img src="images/internet.png"/>网络营销管理</a>
        <ul style="display: none;">
    ...
    <div class="pure-menu pure-menu-open n-menu ">
        <a class="pure-menu-heading"><img src="images/tool.png"/>控制面板</a>
        <ul>
